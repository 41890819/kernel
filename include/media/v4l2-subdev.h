...
struct v4l2_subdev_core_ops {
	...
	int (*s_ctrl_1)(struct v4l2_subdev *sd, struct v4l2_control *ctrl,unsigned char select_mode);
	int (*soft_reset)(struct v4l2_subdev *sd, int isp_cmd);
	int (*s_ctrl_iic)(struct v4l2_subdev *sd,struct v4l2_control *ctrl);
