...
struct v4l2_fmt_data {
	...
	unsigned short sensor_sys_pclk; /* MBps. */
...
#define V4L2_ACQUIRE_QUICK_PHOTO	(0x00000010)
#define V4L2_ACQUIRE_LIVING_PHOTO	(0x00000100)
...
#define V4L2_CID_GET_AF_FLAG		(V4L2_CID_PRIVATE_BASE + 4)
#define V4L2_CID_GET_AF_STATE           (V4L2_CID_PRIVATE_BASE + 5)
#define V4L2_CID_CAPTURE_RAW		(V4L2_CID_PRIVATE_BASE + 6)
#define V4L2_CID_PROCESS_RAW		(V4L2_CID_PRIVATE_BASE + 7)
#define V4L2_CID_SENSOR_GROUP_LUNCH	(V4L2_CID_PRIVATE_BASE + 8)
#define V4L2_CID_ISP_SETTING_SWITCH	(V4L2_CID_PRIVATE_BASE + 9)
#define V4L2_CID_ISP_FACE_EXPOSURE	(V4L2_CID_PRIVATE_BASE + 10)
