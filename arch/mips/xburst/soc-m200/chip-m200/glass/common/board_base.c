...
#define DEF_DEVICE(DEVICE, DATA, SIZE)	\
	...
	DEF_DEVICE(&ingenic_leds, 0, 0),
#endif
#ifdef CONFIG_TOUCHPANEL_VIRTUAL
	DEF_DEVICE(&virtual_tp_device, 0, 0),
#endif
	...
	DEF_DEVICE(&i2c3_gpio_device, 0, 0),
        ...
        DEF_DEVICE(&i2c4_gpio_device, 0, 0),
#endif

#ifdef CONFIG_SOFT_I2C5_GPIO_V12_JZ
	DEF_DEVICE(&i2c5_gpio_device, 0, 0),
#endif

#ifdef CONFIG_SOFT_I2C6_GPIO_V12_JZ
	DEF_DEVICE(&i2c6_gpio_device, 0, 0),
#endif
	...
	DEF_DEVICE(&flashlamp_device, 0, 0),
#endif
	...
	DEF_DEVICE(&virtual_device, 0, 0),
#endif
#ifdef CONFIG_LCD_ECX336AF
	DEF_DEVICE(&ecx336af_device, 0, 0),
#endif
#ifdef CONFIG_LCD_HIMAX7033
	DEF_DEVICE(&himax7033_device, 0, 0),
#endif
#ifdef CONFIG_LCD_HIMAX7097
	DEF_DEVICE(&himax7097_device, 0, 0),
#endif
#ifdef CONFIG_LCD_HIMAX7097_SECOND
	DEF_DEVICE(&himax7097_second_device, 0, 0),
#endif
	...
	DEF_DEVICE(&ili9342c_device, 0, 0),
#endif
...
static int __init board_base_init(void)
{
	...
	mipi_dsi_register_lcd_device(&himax7069_device);
#endif
	...
	i2c_register_board_info(3, jz_i2c3_devs, jz_i2c3_devs_size);
        ...
        i2c_register_board_info(4,jz_i2c4_devs,jz_i2c4_devs_size);
#endif

#if defined(CONFIG_SOFT_I2C5_GPIO_V12_JZ)
	i2c_register_board_info(5, jz_i2c5_devs, jz_i2c5_devs_size);
#endif

#if defined(CONFIG_SOFT_I2C6_GPIO_V12_JZ)
	i2c_register_board_info(6, jz_i2c6_devs, jz_i2c6_devs_size);
#endif
