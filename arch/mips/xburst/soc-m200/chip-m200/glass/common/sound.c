...
struct snd_codec_data __attribute__((weak)) codec_data = {
	...
	.gpio_usb_detect = {.gpio = GPIO_USB_HP_DETE, .active_level = GPIO_USB_DETE_LEVEL},
	.gpio_usb_sel = {.gpio = GPIO_AUDIO_USB_SEL, .active_level = GPIO_AUDIO_USB_SEL_LEVEL},
