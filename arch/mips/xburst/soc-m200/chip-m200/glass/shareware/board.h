...
#define CAMERA_AF_EN		GPIO_PE(1)
#define CAMERA_I2C_ADDR         0x36
#endif
#define CAMERA_RST		GPIO_PE(0)
...
/* ****************************GPIO LIGHT_SENSOR START ************************** */
#define GPIO_ISL29035_INT   GPIO_PA(10)
/* ****************************GPIO LIGHT_SENSOR END****************************** */
