...
#define DC2_NAME "cpu_vmem"
#define DC3_NAME "ir3v3"
#define DC4_NAME "cpu_1v8"
#define DC5_NAME "dvdd"
#define LDO1_NAME "dovdd"
#define LDO2_NAME "emmc_vcc"
#define LDO3_NAME "amp_vdd"
#define LDO4_NAME "lcd_iovcc"
#define LDO5_NAME "cpu_2v5"
#define LDO6_NAME "cpu_3v3"
#define LDO7_NAME "lcd_vcc"
#define LDO8_NAME "gps"
#define LDO9_NAME "dmic_vdd"
...
#define CH_VFCHG	 0x04	/* VFCHG	= 0 - 4 (4.05v, 4.10v, 4.15v, 4.20v, 4.35v) */
#define	CH_VRCHG 	 0x04	/* VRCHG	= 0 - 4 (3.85v, 3.90v, 3.95v, 4.00v, 4.10v) */
#define CH_VBATOVSET 	 0x01	/* VBATOVSET	= 0 or 1 (0 : 4.38v(up)/3.95v(down) 1: 4.53v(up)/4.10v(down)) */
#define CH_ICHG	  	 0x0d	/* ICHG		= 0 - 0x1D (100mA - 3000mA) */
#define CH_ILIM_ADP 	 0x0e	/* ILIM_ADP	= 0 - 0x1D (100mA - 3000mA) */
#define CH_ILIM_USB 	 0x0e	/* ILIM_USB	= 0 - 0x1D (100mA - 3000mA) */
#define CH_ICCHG 	 0x03	/* ICCHG	= 0 - 3 (50mA 100mA 150mA 200mA) */
#define FG_TARGET_VSYS   3400	/* This value is the target one to DSOC=0% */
#define FG_TARGET_IBAT   100    /* This value is the target one to DSOC=0% */
#define FG_POFF_VBAT 	 0	/* setting value of 0 per Vbat */
#define FG_RSENSE_VAL	 20	/* setting value of R Sense */
...
#define JT_VFCHG_H 	 0x04	/* VFCHG High  	= 0 - 4 (4.05v, 4.10v, 4.15v, 4.20v, 4.35v) */
#define	JT_VFCHG_L 	 0x02	/* VFCHG High  	= 0 - 4 (4.05v, 4.10v, 4.15v, 4.20v, 4.35v) */
