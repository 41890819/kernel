...
#endif
/* ****************************GPIO BLUETOOTH END**************************** */
#define INGENIC_LED_GPIO_BLUE GPIO_PE(0)
#define INGENIC_LED_GPIO_GREEN GPIO_PA(29)
#define INGENIC_LED_GPIO_ORANGE GPIO_PE(3)

#define INGENIC_LED_GPIO_RED1 GPIO_PC(24) //blue
#define INGENIC_LED_GPIO_RED GPIO_PC(23) //green
#define INGENIC_LED_GPIO_RED3 GPIO_PC(22) //orange
