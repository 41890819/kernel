...
#if (defined(CONFIG_SOFT_I2C0_GPI2_V12_JZ) || defined(CONFIG_I2C2_V12_JZ))
...
#ifdef CONFIG_SENSOR_GP2AP054A
static struct gp2ap054a_platform_data gp2ap054a_platform_data = {
	 .gpio = GPIO_GP2AP054A_INT,
};
#endif
...
#ifdef CONFIG_SENSOR_GP2AP054A
	{
		I2C_BOARD_INFO("gp2ap054a", 0x39),
		.platform_data  = &gp2ap054a_platform_data,
	},
#endif
};
#endif
