...
#define ECX336AF_SPI_CS GPIO_PD(27)
#define ECX336AF_SPI_CLK GPIO_PE(1)
#define ECX336AF_SPI_SDI GPIO_PC(9)
/* ****************************GPIO LCD END********************************** */
...
#define GPIO_KEY_A              GPIO_PA(11)
#define ACTIVE_LOW_A     	1
...
#define INGENIC_LED_GPIO_GREEN GPIO_PC(19)
#define INGENIC_LED_GPIO_BLUE GPIO_PA(10)
