...
__initdata int gpio_ss_table[][2] = {
	...
	{32*0+10,	GSS_OUTPUT_LOW		},	/* LS_INT */
	{32*0+11,	GSS_OUTPUT_LOW  	},	/* USB_S */
	{32*0+12,	GSS_OUTPUT_HIGH		},	/* ALS_INT */
	{32*0+13,	GSS_IGNORE      	},	/* CIM_PWDN_N */
	...
	{32*0+29,	GSS_OUTPUT_HIGH 	},	/* TP_INT_CPU */
	{32*1+0,	GSS_OUTPUT_HIGH 	},	/* TP_RESET */
	...
	{32*2+18,	GSS_OUTPUT_LOW       	},	/* LCD_SCK */
	{32*2+19,	GSS_OUTPUT_LOW  	},	/* LCD_SDA */
	...
	{32*3+26,	GSS_OUTPUT_LOW		},	/* AMP_MUTE */
	{32*3+27,	GSS_OUTPUT_LOW		},	/* CIM_RST_N */
	{32*3+28,	GSS_INPUT_NOPULL	},	/* AF_EN */
	{32*3+29,	GSS_OUTPUT_LOW		},	/* VOL+ */
	{32*3+30,	GSS_INPUT_NOPULL	},	/* SMB0_SDA */
	{32*3+31,	GSS_INPUT_NOPULL	},	/* SMB0_CLK */
	{32*4+0,	GSS_INPUT_NOPULL	},	/* SMB2_SDA */
	{32*4+1,	GSS_OUTPUT_HIGH  	},	/* LCD_PWM */
