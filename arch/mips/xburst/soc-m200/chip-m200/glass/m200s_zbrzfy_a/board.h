...
#define INGENIC_LED_GPIO_RED1 GPIO_PD(28)
/* ****************************GPIO LEDS END******************************** */
...
#define GPIO_KEY_L		GPIO_PC(15)
#define ACTIVE_LOW_L	1
#define WAKE_EN_L    0

#define GPIO_KEY_P		GPIO_PC(16)
#define ACTIVE_LOW_P	1
#define WAKE_EN_P    0

#define GPIO_CAMERA_KEY		GPIO_PC(22)
#define ACTIVE_LOW_CAMERA	1

#define GPIO_KEY_A		GPIO_PC(23)
