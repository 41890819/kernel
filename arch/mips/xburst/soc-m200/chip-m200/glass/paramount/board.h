...
#define GPIO_AR_KEY		GPIO_PD(17)
#define ACTIVE_LOW_AR		1
...
#define GPIO_LSENSOR_INT    GPIO_PA(10)
/******************************GPIO LIGHT SENSOR END************************* */

/******************************GPIO Proximity SENSOR START*********************** */
#define GPIO_PSENSOR_INT    GPIO_PD(27)
/******************************GPIO Proximity SENSOR END************************* */
...
#define CAMERA_AF_EN		-1//GPIO_PE(1)
...
#define GPIO_SPEAKER_EN	   	GPIO_PD(28)	      /*speaker enable gpio*/
...
#define GPIO_AUDIO_USB_SEL_LEVEL       	 1
