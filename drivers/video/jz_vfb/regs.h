...
#define LCDC_ENH_DITHERCFG_DITHERMD_RED_MASK	(0x01 << LCDC_ENH_DITHERCFG_DITHERMD_RED_BIT)
#define LCDC_ENH_DITHERCFG_DITHERMD_GREEN_BIT	2
#define LCDC_ENH_DITHERCFG_DITHERMD_GREEN_MASK	(0x01 << LCDC_ENH_DITHERCFG_DITHERMD_GREEN_BIT)
#define LCDC_ENH_DITHERCFG_DITHERMD_BLUE_BIT	0
#define LCDC_ENH_DITHERCFG_DITHERMD_BLUE_MASK	(0x01 << LCDC_ENH_DITHERCFG_DITHERMD_BLUE_BIT)
